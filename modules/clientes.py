...
class ClientesWindow(QMainWindow):
    ...
    def mostrar_clientes(self):
        try:
            ...
            cursor.execute("SELECT id,nombre,apellido,telefono FROM cliente where activo=1")
    ...
    def buscar_cliente(self):
        ...
        try:
            ...
            if not conexion.is_connected():
                print("¡Error! La conexión no está activa.")
                return
            cursor.execute("SELECT nombre, apellido, telefono FROM cliente WHERE id = %s", (id,))
